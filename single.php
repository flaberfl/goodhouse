    ...
    <nav class="breadcrumbs__container">
      <ul class="breadcrumbs__list">
        ...
        <li class="breadcrumbs__item breadcrumbs__item_active"><a href="">Снять квартиру в Екатеринбурге
            <span>/</span>&nbsp;</a></li>
        <li class="breadcrumbs__item">1-к квартира по ул. Циолковского 29</li>
      </ul>
    </nav>
  </div>
      ...
      <div class="flat__row">
        <div class="flat__content">
            ...
            <div class="swiper gallery-top__slider">
              <div class="swiper-wrapper gallery-top__wrapper">
                <div class="swiper-slide gallery-top__slide">
                  <img data-src=" img/flat/flat-img.webp" alt="Image">
                </div>
                <div class="swiper-slide gallery-top__slide">
                  <img data-src=" img/flat/flat-img.webp" alt="Image">
                </div>
            ...
            <div class="swiper gallery-thumbs__slider">
              <div class="swiper-wrapper gallery-thumb__wrapper">
                <div class="swiper-slide gallery-thumbs-slide">
                  <img data-src="<?php echo get_template_directory_uri() ?>/assets/img/flat/flat-thumb.webp" alt="Image">
                </div>
                <div class="swiper-slide gallery-thumbs-slide">
                  <img data-src="<?php echo get_template_directory_uri() ?>/assets/img/flat/flat-thumb.webp" alt="Image">
                </div>
              ...
              <!-- <button class="swiper-button-prev gallery-arrow gallery-thumbs-prev">
										<svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path
												d="M12.9421 6.26017H4.12231L7.32286 3.24789L6.46785 2.44318L1.80762 6.82927L6.46785 11.2154L7.32286 10.4107L4.12231 7.39838H12.9421V6.26017Z"
												fill="#116CF0" />
										</svg>
									</button>
									<button class="swiper-button-next gallery-arrow gallery-thumb-next">
										<svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path
												d="M2.0579 6.3577H10.8777L7.67714 3.34543L8.53215 2.54071L13.1924 6.92681L8.53215 11.3129L7.67714 10.5082L10.8777 7.49591H2.0579V6.3577Z"
												fill="#116CF0" />
										</svg>
									</button> -->
            </div>
          ...
          <div class="flat__info">
            <div class="flat__adress flat-title"><span>1-к квартира, ул. Циолковского 29</span>
            ...
            <div class="flat__price">3 700 ₽ за сутки</div>

            <div class="item-catalog__desc">
              <span class="item-desc item-flat">2 кровати</span>
              <span class="item-desc item-beds">25 м²</span>
              <span class="item-desc item-sq">15/17 этаж</span>
            </div>
            ...
            <div class="flat__text-wrapper">
              <div class="flat__text-content">
                ...
                <div class="flat__text">
                  Квартира расположена в новом доме в центре города.В ПЕШЕЙ ДОСТУПНОСТИ: Втузгородок. Здесь
                  расположен
                  Президиум Уральского отделения Академии наук, УГТУ-УПИ, Уральской юридической академии, Уральском
              ...
              <div class="flat__equipment-list">
                <div class="flat__equipment-item">
                  <div class="flat__equipment__icon">
                    <img data-src="<?php echo get_template_directory_uri() ?>/assets/img/flat/01.svg" alt="Image">
                  </div>
                ...
                <div class="flat__equipment-item">
                  <div class="flat__equipment-icon">
                    <img data-src="<?php echo get_template_directory_uri() ?>/assets/img/flat/02.svg" alt="Image">
                  </div>
                  <div class="flat__equipment-name">
                    Двуспальная кровать
                  </div>
                ...
                <div class="flat__equipment-item">
                  <div class="flat__equipment-icon">
                    <img data-src="<?php echo get_template_directory_uri() ?>/assets/img/flat/03.svg" alt="Image">
                  </div>
                  <div class="flat__equipment-name">
                    Холодильник
                  </div>
                ...
                <div class="flat__equipment-item">
                  <div class="flat__equipment-icon">
                    <img data-src="<?php echo get_template_directory_uri() ?>/assets/img/flat/04.svg" alt="Image">
                  </div>
                  <div class="flat__equipment-name">
                    Телевизор
                  </div>
            ...
            <div class="flat__rules">
              ...
              <div class="flat__rules-list">
                <div class="flat__rules-item">
                  <div class="flat__rules-name">Заезд после</div>
                  <div class="flat__rules-value">не указано</div>
                </div>
                <div class="flat__rules-item">
                  <div class="flat__rules-name">Можно курить</div>
                  <div class="flat__rules-value">нет</div>
                </div>
                <div class="flat__rules-item">
                  <div class="flat__rules-name">Выезд</div>
                  <div class="flat__rules-value">не указано</div>
                </div>
                <div class="flat__rules-item">
                  <div class="flat__rules-name">Разрешены вечеринки</div>
                  <div class="flat__rules-value">нет</div>
                </div>
                <div class="flat__rules-item">
                  <div class="flat__rules-name">Бесконтактное заселение</div>
                  <div class="flat__rules-value">да</div>
                </div>
                <div class="flat__rules-item">
                  <div class="flat__rules-name">Есть отчетные документы</div>
                  <div class="flat__rules-value">да</div>
                </div>
                <div class="flat__rules-item">
                  <div class="flat__rules-name">Можно с животными</div>
                  <div class="flat__rules-value">нет</div>
                </div>
              </div>
            </div>
        ...
        <div class="flat__geo">
          <div class="flat__map">
            <div id="map"></div>
            <button data-da=".flat__info, 767, 3" class="flat__btn flat__btn_blue btn"><span>Забронировать</span></button>
                ...
                <div class="flat__more-item">
                  ...
                  <div class="swiper item-catalog__photos flat-catalog-photos">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide"><img data-src="<?php echo get_template_directory_uri() ?>/assets/img/slider/01.webp" alt="Image"></div>
                      <div class="swiper-slide"><img data-src="<?php echo get_template_directory_uri() ?>/assets/img/slider/01.webp" alt="Image"></div>
                      <div class="swiper-slide"><img data-src="<?php echo get_template_directory_uri() ?>/assets/img/slider/01.webp" alt="Image"></div>
                    </div>
                    <div class="item-catalog__favorite">
                    ...
                    <div class="swiper-pagination item-catalog__pagination flat__pagination">
                    </div>
                  </div>

                  <div class="flat__more-info">
                    <div class="flat__more-adress">ул. Циолковского 29</div>
                    <div class="flat__more-price">3 700 ₽ за сутки</div>
                    <div class="item-catalog__desc">
                      <span class="item-desc item-flat">2 кровати</span>
                      <span class="item-desc item-beds">25 м²</span>
                      <span class="item-desc item-sq">15/17 этаж</span>
                    ...
                    <div class="flat__more-text">
                      Для тех, кто стремится жить в мегаполисе с комфортом, сохраняя свою индивидуальность. Единая
                      комплексная среда с развитой...
                    </div>
                    <div class="flat__more-btn btn"><span>Забронировать</span></div>
                  </div>
                </div>
              </div>
              <div class="flat__more-slide swiper-slide">
